...
export function CafeMap({
  ...
  return (
    <section
      ...
      className="glass relative overflow-hidden rounded-2xl border border-primary/25 floor-grid neon-ring"
    >
      {/* Animated scanline sheen sweeping over the floor */}
      <div className="scan-sheen" aria-hidden="true" />

      {/* Neon sparks drifting up like dust in neon light */}
      <Sparks />

      {/* Floating crystal shards, like the Kazoza logo artwork */}
      <span className="crystal" style={{ top: '8%', left: '6%' }} aria-hidden="true" />
      <span
        className="crystal"
        style={{ top: '18%', right: '8%', animationDelay: '-3s' }}
        aria-hidden="true"
      />
      <span
        className="crystal"
        style={{ bottom: '22%', left: '10%', animationDelay: '-5s' }}
        aria-hidden="true"
      />
      <span
        className="crystal"
        style={{ bottom: '10%', right: '5%', animationDelay: '-7s' }}
        aria-hidden="true"
      />
